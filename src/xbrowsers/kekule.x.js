...
module.exports = function (Kekule) {
    ...
    if (typeof (navigator) === "undefined")   // not in browser environment, node.js?
    {
    ...
    else {     // start of browser detect part
        /**
         * Browser Check.
         * @class
         */
        ...
        if (Kekule.$jsRoot.window) {
            Kekule.BrowserFeature = {
                ...
                htmlTemplate: !!window.HTMLTemplateElement,
                htmlSlot: !!window.HTMLSlotElement,
    ...
    if (Kekule.$document) {
        if (Kekule.$document.addEventListener)  // W3C browser
        {
        ...
        else if (Kekule.$document.attachEvent)  // IE 8
        {
