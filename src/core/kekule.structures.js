		...
		if (!result && options.method === Kekule.ComparisonMethod.CHEM_STRUCTURE)
		{
			//if (this._getComparisonOptionFlagValue(options, 'atom'))
			{
				...
				if (!result && this.hasCtab())
				{
					...
					// structure fragment, if with same node and connector count, compare nodes and connectors
					if ((result === 0) && (this.getNonHydrogenNodes && targetObj.getNonHydrogenNodes)) {  
